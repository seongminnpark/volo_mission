...
/**
 *  `VLOPathMaker`는 타임라인 커버 위에 요약된 경로를 표시하기 위해,
 *  지도상의 길과 같이 구부러진 UIBezierPath를 생성합니다.
 */
@interface VLOPathMaker : NSObject
 ...
 */
- (UIBezierPath *) pathBetweenPoint:(CGPoint)from point:(CGPoint)to;
