...
- (NSMutableArray *) get_coordinates: (NSArray *)lo
{
    ...
    if(lo.count==0)
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Announcement" message:@"입력된 지도/경로 정보가 없습니다." delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
    ...
    else
    {
        ...
        //add
        NSLog(@"start-end distance -> %f",x_diff);
